...
public partial class DbAbac9aAnimalitospharmaContext : DbContext
{
    public DbAbac9aAnimalitospharmaContext()
    {
    }

    public DbAbac9aAnimalitospharmaContext(DbContextOptions<DbAbac9aAnimalitospharmaContext> options)
        : base(options)
    {
    }
